/*
  ...
  1. New Tables
    - `product_videos` - Store product video metadata and links to storage
      - `id` (uuid, primary key)
      - `product_id` (uuid, foreign key to products)
      - `video_url` (text) - Public URL for the video
  ...
  3. Indexes
    - Add performance indexes for product_id and storage_path
*/
