...
const ProductDetailPage = () => {
  ...
  const getProductImage = (index: number = 0) => {
    if (!product?.product_images || product.product_images.length === 0) {
      return 'https://images.pexels.com/photos/10018318/pexels-photo-10018318.jpeg?auto=compress&cs=tinysrgb&w=1600';
    }
    return product.product_images[index]?.image_url;
  };
  ...
  const has3DModel = () => {
    return product?.ijewel_url && isValidIJewelUrl(product.ijewel_url);
  };
            ...
            <div className="relative aspect-square rounded-lg overflow-hidden bg-white">
              {selectedMediaType === 'image' && combinedMedia[selectedMediaIndex] && (
                <img
                  ...
                  onClick={() => openImageModal(combinedMedia[selectedMediaIndex].url)}
                />
              )}
              ...
              <div className="bg-white rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    {product.diamond_color && (
                      <div className="flex justify-between py-2 border-b border-cream-200">
                        <span className="text-charcoal-600">Diamond Color</span>
                        <span className="font-medium">{product.diamond_color}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                >
                  <div className="relative aspect-square overflow-hidden">
                    <Link to={`/product/${relatedProduct.id}`}>
                      <img
                        src={relatedProduct.product_images?.[0]?.image_url || 'https://images.pexels.com/photos/10018318/pexels-photo-10018318.jpeg?auto=compress&cs=tinysrgb&w=1600'}
