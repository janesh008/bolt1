...
import ProductInfoModal from '../../admin/products/ProductInfoModal';
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (debouncedSearchTerm) {
        query = query.or(`product_name.ilike.%${debouncedSearchTerm}%,name.ilike.%${debouncedSearchTerm}%,product_id.ilike.%${debouncedSearchTerm}%,description.ilike.%${debouncedSearchTerm}%`);
      }
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">{product.product_id || product.id.slice(0, 8)}</div>
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
